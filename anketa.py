...
hcolss = st.columns(2)
with hcolss[0]:
    st.markdown('<p style="font-size:50px; color:#26822F"><b>АНКЕТА ПОСЕТИТЕЛЯ ВЫСТАВКИ</b></p>', unsafe_allow_html=True)
with hcolss[-1]:
    ac = st.columns(6)
    with ac[-1]:
...
st.markdown('---')
# st.markdown('<p style="font-size:680px">ТЕКСТ</p>', unsafe_allow_html=True)
